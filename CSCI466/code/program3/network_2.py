...
class NetworkPacket:
    ...
    def __init__(self, dst_addr, data_S , flag=0, offset=0):    #now takes in flag and offset "to allow the destination host to perform reassembly tasks" (pg 333)
    ...
    def from_byte_S(self, byte_S, mtu):
        ...
        while True:
            ...
            packets.append(self(dst_addr, data_S[offset_size:offset_size + mtu - self.header_length], seg_flag, offset_size))   #add to array of received segments
